...
await rm('dist/client/assets/projects/zoumaling/zoumaling-site-demo-original.mp4', { force: true })
await rm('dist/client/assets/projects/zoumaling/zoumaling-site-demo-720p.m4v', { force: true })
